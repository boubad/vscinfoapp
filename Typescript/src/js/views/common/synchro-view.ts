...
import {SYNC_IN, SYNC_OUT, SYNC_DATABASE,DATABASE_NAME, REMOTE_DATABASE_NAME,
   REMOTESERVERSLIST_KEY,SYNC_CHANNEL, SYNC_ERROR, SYNC_PAUSED, SYNC_CHANGED,
   SYNC_COMPLETED, SYNC_DENIED, SYNC_STARTED,
    SYNC_RESUMED} from '../../utils/infoconstants';
import {BaseView} from '../../viewmodel/baseview';
import * as userinf from '../../viewmodel/userinfo';
import * as syncman from '../../viewmodel/syncmanager';
import {IInfoMessage} from 'infodata';
//
@autoinject
export class SynchroView extends BaseView {
  //
  public manager: syncman.SynchroManager;
  //
  ...
  //
  constructor(userinfo: userinf.UserInfo, manager: syncman.SynchroManager) {
    super(userinfo);
